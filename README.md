...
| Data | `list` | Read-only listing of system definition data: surfaces, asphere coefficients, thickness differences and glasses. Flags: `--format table\|yaml\|json\|csv`, `--config`, `--glass-dir`, `--curvature`. See `docs/list.md`. | YAML system → formatted table / yaml / json / csv |
...
| [docs/list.md](docs/list.md) | surfaces, glasses, asphere coefficients, thickness differences |
