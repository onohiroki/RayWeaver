...
func TestCycleTimeBudgetStopsEarly(t *testing.T) {
	...
	cycle := NewCycle(wrapper, store, params, 10, 0, nil, deadline, context.Background(), nil, nil, nil, false)
...
func TestCycleHardStopInterruptsMidSolve(t *testing.T) {
	...
	cycle := NewCycle(wrapper, store, params, cfg.MaxCycles, 0, nil, time.Time{}, ctx, hardStop, nil, nil, false)
