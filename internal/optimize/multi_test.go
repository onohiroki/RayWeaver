...
func TestMultiOptimizerSeidelDistortionKind(t *testing.T) {
	...
	opt := NewMultiOptimizer(configs, nil, nil, gc, 1, 0.01, 1e-6, 1e-6, 2.0, 64, 0, 0, nil, nil, 0, 0)
	x := []float64{}
...
func TestMultiOptimizerApplySharedVariables(t *testing.T) {
	...
	opt := NewMultiOptimizer(configs, sharedVars, nil, gc, 1, 0.01, 1e-6, 1e-6, 2.0, 64, 0, 0, nil, nil, 0, 0)
...
func TestMultiOptimizerApplyLocalVariables(t *testing.T) {
	...
	opt := NewMultiOptimizer(configs, nil, localVars, gc, 1, 0.01, 1e-6, 1e-6, 2.0, 64, 0, 0, nil, nil, 0, 0)
	x := []float64{75.0}
	configSurfaces, _ := opt.applyVariables(x)
...
func TestMultiOptimizerSizeAutoAperturesGeometric(t *testing.T) {
	...
	opt := NewMultiOptimizer(configs, nil, nil, gc, 10, 1.0, 1e-6, 1e-6, 1.0, 64, 100.0, 0, nil, nil, 0, 0)
...
func TestMultiOptimizerGetInitialState(t *testing.T) {
	...
	opt := NewMultiOptimizer(configs, sharedVars, localVars, gc, 1, 0.01, 1e-6, 1e-6, 2.0, 64, 0, 0, nil, nil, 0, 0)
...
func TestMultiOptimizerSatisfiableEqualityConstraints(t *testing.T) {
	...
	opt := NewMultiOptimizer(configs, nil, localVars, tripletGC(), 80, 0.01, 1e-6, 1e-6, 1.0, 64, 100, 0, nil, nil, 0, 0)
	result := opt.Optimize()
...
func TestMultiOptimizerApertureMarginClamp(t *testing.T) {
	...
	opt := NewMultiOptimizer(configs, nil, nil, gc, 10, 0.01, 1e-6, 1e-6, 0.8, 64, 100, 0, nil, nil, 0, 0)
...
func TestMultiOptimizerAsphereVariables(t *testing.T) {
	...
	opt := NewMultiOptimizer(configs, nil, localVars, gc, 5, 0.01, 1e-6, 1e-6, 1.0, 64, 100, 0, nil, nil, 0, 0)
...
func TestMultiOptimizerMeritBreakdown(t *testing.T) {
	...
	opt := NewMultiOptimizer(configs, nil, localVars, tripletGC(), 10, 0.01, 1e-6, 1e-6, 1.0, 64, 100, 0, nil, nil, 0, 0)
