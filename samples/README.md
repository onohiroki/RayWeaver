...
| `psf-demo.bash` | Point-spread-function demo using `us2645157.yaml`: per-field PSF maps (gnuplot pm3d) and a radial-profile overlay via `rayweave psf` (RCP+LCP), plus a Strehl / FWHM / EE50 / Airy comparison table (`psf-demo-result.txt`). |
