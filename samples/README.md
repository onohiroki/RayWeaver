...
| `glass-attraction-demo.bash` | Base vs glass-attraction comparison. Two DLS runs (base + attraction), compares nd/vd, spot RMS, and displays `opt_results.glass_attraction` diagnostics. |
